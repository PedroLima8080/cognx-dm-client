...
export default function ThreadView({ conversationId, onBack }: { conversationId: string; onBack: () => void }) {
  ...
  return (
    <div>
      <button onClick={onBack} className="mb-2 text-sm font-medium text-blue-600">
        ← voltar
      </button>
